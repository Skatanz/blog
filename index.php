...
<header>
    <div class="container-fluid mt-3"> 
        ...
        <div class="shadow px-2 py-3 mb-3 bg-info text-white text-center">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-lg-4 mx-auto pt-5">
                <div class="mx-5">
                    <h5 class=" bg-info rounded text-white  py-2 px-2">プロフィール</h5>
                ...
                <div class="mx-5">
                    <h5 class="bg-info rounded text-white mt-2 py-2 px-2">最新の投稿</h5>
                    <div class="mt-3">
